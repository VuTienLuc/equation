        ...
        <div className="fixed inset-0 bg-slate-900/50 backdrop-blur-sm z-[100] flex items-center justify-center p-4 animate-in fade-in duration-200">
            <div className="bg-white rounded-2xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-hidden flex flex-col">
                ...
                <div className="p-6 overflow-y-auto space-y-6">
                    ...
                    {/* Donation Section */}
                    <div className="mt-8 p-6 bg-amber-50 rounded-2xl border border-amber-200 shadow-sm">
                        <div className="flex flex-col items-center text-center">
                            ...
                            <div className="bg-white p-5 rounded-2xl shadow-md border border-amber-100 w-full max-w-[280px]">
                                ...
                                <img 
                                    src={`https://img.vietqr.io/image/agribank-0969068849-compact2.png?amount=0&addInfo=Moi%20cafe%20MathDoc%20AI&accountName=VU%20TIEN%20LUC`} 
                                    alt="QR Agribank Vũ Tiến Lực" 
                                    className="w-48 h-48 mx-auto mb-4 border border-slate-50 rounded-lg p-1"
                                />
                                
                                <div className="pt-3 border-t border-slate-100 text-center">
                                    <div className="text-xs text-slate-400 font-medium mb-1 uppercase tracking-tighter">Chủ tài khoản</div>
                                    <div className="font-bold text-slate-800 text-base mb-1">VŨ TIẾN LỰC</div>
                                    <div className="inline-block px-3 py-1 bg-amber-100 text-amber-800 rounded-full font-mono text-sm font-bold">
                                        0969 068 849
                                    </div>
                                </div>
                            </div>
                            <p className="mt-4 text-[11px] text-amber-700 italic font-medium">
                                * Số điện thoại trên dùng làm số tài khoản Agribank
                            </p>
                        </div>
                    </div>
                </div>
